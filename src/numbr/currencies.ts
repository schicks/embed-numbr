...
export const currencies: { [id: CurrencyCode]: CurrencyInfo } = currenciesData as any
export const cryptoCurrencies: { [id: CurrencyCode]: CurrencyInfo } = cryptoData as any
